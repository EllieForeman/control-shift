  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm">
        ...
        <p>Or if you would like to become part of the Control Shift community subscribe to our email list below and send us a message. If you would just like to receive updates about Control Shift then just subscribe to the email list.</p>
